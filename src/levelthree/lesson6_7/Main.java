...
import levelthree.lesson6_7.tests.TestClassOne;
import levelthree.lesson6_7.tests.TestClassTwo;
...
public class Main {
    public static void main(String[] args) {
        TestClassOne testClass1 = new TestClassOne();
        Class clazz = testClass1.getClass();

        start(clazz);

        TestClassTwo testClass2 = new TestClassTwo();
